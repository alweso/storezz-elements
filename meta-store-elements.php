...
final class Storezz_Elements {
  ...
  */
  const STOREZZ_ELEMENTS_VERSION = '1.0.1';
  ...
  */
  public function __construct() {
    ...
    /** Necessary Constants */
    define("STOREZZ_ELEMENTS_VERSION", '1.0.1' );

    /** Plugin URI */
    define("STOREZZ_ELEMENTS_PATH", plugin_dir_path( __FILE__ ) );
    define("STOREZZ_ELEMENTS_URI", plugin_dir_url( __FILE__ ) );
    define("STOREZZ_ELEMENTS_ASSETS_URI", STOREZZ_ELEMENTS_URI . '/assets/' );
    define("STOREZZ_ELEMENTS_VENDOR_URI", STOREZZ_ELEMENTS_URI . '/assets/vendor/' );
  ...
  */
  ...
  public function add_elementor_styles_and_scripts() {
    ...
    wp_enqueue_style( 'storezz-elements-style', STOREZZ_ELEMENTS_ASSETS_URI . 'css/storezz-elements.css', array(), STOREZZ_ELEMENTS_VERSION );

    /** Elegant Icons */
    wp_enqueue_style( 'elegant-icons', STOREZZ_ELEMENTS_VENDOR_URI . 'elegant-icons/style.css', array(), STOREZZ_ELEMENTS_VERSION );

    /** Custom Widget Scripts */
    wp_enqueue_script( 'storezz-elements-scripts', STOREZZ_ELEMENTS_ASSETS_URI . 'js/mse-custom-scripts.js', array('jquery'), STOREZZ_ELEMENTS_VERSION );
  }
  ...
  */
  public function init_widgets() {
    ...
    require_once( __DIR__ . '/widgets/storezz-navigation-menu-widget.php' ); // Countdown
    ...
    \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Storezz_Navigation_Menu() ); // Countdown

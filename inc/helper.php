...
if( !function_exists( 'storezz_elements_post_lists' ) ) {
  function storezz_elements_post_lists($multiple) {
    ...
    if( $multiple ) {
      $post_list = array('all' => esc_html('All', 'storezz-elements'));
    } else {
      $post_list = array('none' => esc_html('None', 'storezz-elements'));
    }
...
if( !function_exists( 'storezz_elements_tag_lists' ) ) {
  function storezz_elements_tag_lists() {
    return array(
      'h1' => esc_html('H1', 'storezz-elements'),
      'h2' => esc_html('H2', 'storezz-elements'),
      'h3' => esc_html('H3', 'storezz-elements'),
      'h4' => esc_html('H4', 'storezz-elements'),
      'h5' => esc_html('H5', 'storezz-elements'),
      'h6' => esc_html('H6', 'storezz-elements'),
      'span' => esc_html('Span', 'storezz-elements'),
      'div' => esc_html('Div', 'storezz-elements'),
    );
  }
}
...
if( !function_exists( 'storezz_elements_orderby_list' ) ) {
  function storezz_elements_orderby_list() {
    return array(
      'none' => esc_html( 'None', 'storezz-elements' ),
      'date' => esc_html( 'Date', 'storezz-elements' ),
      'title' => esc_html( 'Title', 'storezz-elements' ),
      'name' => esc_html( 'Name', 'storezz-elements' ),
      'ID' => esc_html( 'ID', 'storezz-elements' ),
    );
  }
}
...
if( !function_exists( 'storezz_elements_order_list' ) ) {
  function storezz_elements_order_list() {
    return array(
      'ASC' => esc_html( 'Ascending', 'storezz-elements' ),
      'DESC' => esc_html( 'Descending', 'storezz-elements' ),
    );
  }
}
...
if( !function_exists( 'storezz_elements_get_woo_categories_list' ) ) {
  function storezz_elements_get_woo_categories_list() {
    $term_list = array('0' => esc_html('Select Category', 'storezz-elements'));
...
if( !function_exists( 'storezz_elements_get_sales_products' ) ) {
  function storezz_elements_get_sales_products() {
    $product_list = array( '0' => esc_html( 'Select Product', 'storezz-elements' ) );
